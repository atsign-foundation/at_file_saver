...
1. Fork in GitHub https://github.com/atsign-foundation/at_file_saver
2. Clone *your forked repository* (e.g., `git clone git@github.com:yourname/at_file_saver`)
3. Set your remotes as follows:

   ```sh
   cd at_file_saver
   git remote add upstream git@github.com:atsign-foundation/at_file_saver.git
   ...
   ```text
   origin  git@github.com:yourname/at_file_saver.git (fetch)
   origin  git@github.com:yourname/at_file_saver.git (push)
   upstream        git@github.com:atsign-foundation/at_file_saver.git (fetch)
